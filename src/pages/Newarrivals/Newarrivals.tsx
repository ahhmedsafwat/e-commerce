...
const NewArrivals = () => {
  ...
  return (
    <div className=" py-16 xLarge:px-6 px-20 medium:px-8 ">
      <h1 className="text-center text-5xl font-secondary">New Arrivals</h1>
      <div className="grid grid-cols-4 large:grid-cols-2 mt-14 mb-8 small:pt-40 overflow-hidden place-items-center">
