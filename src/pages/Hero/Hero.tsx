...
const Hero = () => {
  ...
  return (
    ...
    <div className='bg-whitedark flex 2xl:justify-between items-center py-6 px-16 lg:flex-wrap md:justify-center sm:px-4'>
      ...
      <div className="">
        <h1 className="font-satoshiBold text-6xl w-[29rem] pb-7 sm:text-5xl sm:w-[23rem]">FIND CLOTHES THAT MATCHES YOUR STYLE</h1>
        ...
        <button className="bg-secondory text-primary p-2 rounded-full w-40 hover:bg-gray-500 hover:text-secondory transition duration-500 md:w-[100%] sm:w-[90%]">Shop Now</button>
      
        <div className="flex text-center pt-6 font-satoshiBold text-2xl md:block md:ml-20 overflow-hidden">
            <div className="flex">
        ...
        <hr className="bg-gray-500 w-[1px] h-14 mx-5 md:hidden"/>
          <h1 className="md:pt-3 md:w-[77%] sm:w-[94%]">30,000+ <span className="block font-satoshireguler text-gray-500 text-sm">Happy Customers</span></h1>
        </div>
    </div>

      <img src={hero1} alt="Slide 1" className='2xl:w-[50%]'/>
    </div>
  );
};
export default Hero;
