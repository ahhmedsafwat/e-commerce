...
const Hero = () => {
  return (
    <div className="bg-whitedark flex 2xl:justify-between items-center py-6 px-16 large:flex-wrap medium:justify-center small:px-4">
      <div className="">
        <h1 className="font-satoshiBold text-6xl w-[29rem] pb-7 small:text-5xl small:w-[23rem]">
          FIND CLOTHES THAT MATCHES YOUR STYLE
        </h1>
        <p className="font-satoshireguler pb-7 w-[35rem] xLarge:w-[30rem] text-gray-500 medium:w-[25rem]">
        ...
        <div className="flex text-center pt-6 font-satoshiBold text-2xl medium:block medium:ml-20 overflow-hidden">
          <div className="flex">
            <h1 className="">
              200+{" "}
          ...
          <h1 className="medium:pt-3 medium:w-[77%] small:w-[94%]">
            30,000+{" "}
            <span className="block font-satoshireguler text-gray-500 text-sm">
              Happy Customers
            </span>
