                ...
                <div className="flex justify-between items-center ">
                    <h1 className="text-5xl font-secondary">OUR HAPPY CUSTOMERS</h1>
                        <div className="flex">
                            ...
                            <LuArrowRight className="cursor-pointer" size={24} onClick={handleScrolrIGHT}/>
                        </div> 
                </div>
            </div>
            <div className="flex pb-40 overflow-hidden w-full space-x-5" ref={scrollableContentRef}>
