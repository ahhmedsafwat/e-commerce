    ...
    return(
        <div className="absolute bg-red-500 w-[90%] 2xl:flex xLarge:flex p-5 justify-between rounded-xl top-[-115px]">
            ...
            <div className="w-2/4">
                ...
                <button className="bg-primary p-2 rounded-full w-full font-satoshiBold">Subscribe to Newsletter</button>
                <img src={MessageIcon} alt="" className="relative top-[-80px] left-[10px]"/>
            </div>
        </div>
    )
}
