      ...
      <div className="flex">
        <div className="size-40 small:size-24 border rounded-md flex items-center justify-center p-3 small:p-1">
          <img
            ...
            src="https://m.media-amazon.com/images/I/71BKudGlMCL._AC_SY625_.jpg"
            alt=""
          />
        </div>
        <div className="ml-4 flex flex-col justify-between ">
          <div>
            ...
            <div className="font-satoshireguler small:text-xs">
              Size:
              <span className="text-gray-400 ml-[2px]">Large</span>
            </div>
            <div className="font-satoshireguler small:text-xs">
              Color: <span className="text-gray-400 ml-[2px]">Blue</span>
            </div>
          </div>
